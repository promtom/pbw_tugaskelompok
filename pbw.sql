...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 16, 2021 at 07:07 AM
...
(1, 'Admin', 'admin', '$2y$10$ecg5JEW5q5lFNsNleftvle8yGskkCwcftR6zFW/zQbB/mpf0LsYTq', 1, 'operator.png', 'Akun Admin dari web ini. Dia sering dipanggil minmin'),
(2, 'Alpha Tester', 'tes', '$2y$10$bWwpMHn4R0HBTff/W0rqLuqnfkAlp2c4NuS3t6FzNsViSOkrc2Pi.', 0, 'uwu.jpg', 'Alpha Tester, The Old User One'),
(3, 'Aldi Mulia Wijaya', 'aldimw', '$2y$10$U8kBYNhiKPdqqeZ0lW5/TOCr4HO3NeSBXKqgeEofNObAH9J4HV6gy', 1, 'dev01.jpg', 'Orang salah jurusan karena salah baca saat daftar'),
(4, 'Muhamad Rafif', 'afiafi', '$2y$10$xF9/WuuPH/km.xzWrCH9XueMzwR9G4VrSz.yVFcH/qRQ26aHChhMu', 1, 'dev02.jpg', 'Susah banget dikontak :('),
(5, 'Ir. Yaddarabullah, M.Kom., IPM', 'yaddarabullah', '$2y$10$HmdTyPcbwUXLLVOTaCLZ4eh0Q9bhXjmqSf9OMOhAemP9dx6AwCwIS', 1, 'dev03.png', 'Yaddarabullah. Lahir di Kota Bekasi, 14 Januari 1990. Menyelesaikan pendidikan dasar di SDN Bojong\r\nRawalumbu X Kota Bekasi (1995-2001), menyelesaikan pendidikan menengah pertama di SMPN 16 Bekasi (2001-\r\n2004). Menamatkan pendidikan menengah kejuruan di SMK Telkom Sandhy Putra Jakarta dengan jurusan Teknik\r\nKomputer Jaringan (2004-2007). Menempuh pendidikan profesi di CEP CCIT Fakultas Teknik Universitas Indonesia\r\ndan Diploma NIIT dengan konsentrasi Network Engineering (2007-2009).\r\nMenyelesaikan pendidikan S1 di Sekolah Tinggi Teknologi Informasi NIIT (2009-2012) dengan program studi Teknik\r\nInformatika. Menyelesaikan pendidikan S2 di Universitas Budi Luhur dengan program studi Ilmu Komputer (2013-\r\n2015). Menyelesaikan pendidikan profesi Insinyur (Ir) di Universitas Hasanuddin (2019-2020). Saat ini aktif\r\nmenjadi pengurus Inkubator Bisnis Trilogi dan Dosen di Prodi Teknik Informatika Universitas Trilogi.'),
(6, 'Beta Tester', 'user', '$2y$10$6CzPQ8sUZ/e8vXLKp0eIc.0WvCwZXoIYgBMEW.NLse.Q.FJxutj9.', 0, '1d03d377423820db43e51c2be54afe7d.png', 'hanya akun tes'),
(7, 'Author Artikel', 'penulis', '$2y$10$yT4jO9mtrusIli.QVessPO1iWpO0hxCIsq0yEfPwCwFnVH4Y8pGkC', 0, 'sandalphon.png', 'Love Indonesia <3');
