		...
		<div class="col-md-12">
			<div class="card">
				...
				<div class="card-body">
					<div class="row">
						<div class="col">
					        <?php echo form_open('admin/kategori/add',array("class"=>"form-horizontal")); ?>
							<div class="form-group mb-3">
								<div class="row-sm-3">
									<label for="kategori_nama">Nama</label>
								</div>
								<div class="row-sm-9">
									<input type="text" class="form-control" name="kategori_nama" id="kategori_nama" placeholder="Type here" required>
								</div>
							</div>
							<div class="form-group mb-3">
								<div class="row-sm-3">
								...
								<div class="row-sm-9">
									<textarea class="form-control" name="kategori_detail" id="kategori_detail" placeholder="Type here" required></textarea>
								</div>
							</div>
							<div class="mb-12">
